...
public class ProducerObjSample {
	...
	public static void sendMessage(Person person) {
		...
		props.put("value.serializer",
				"org.zhubao.spark.kafka.PersonSerializer");

		Producer<String, Person> producer = new KafkaProducer<String, Person>(
				props);
		producer.send(new ProducerRecord<String, Person>("tracking_person",
				person));
		producer.close();
	}
